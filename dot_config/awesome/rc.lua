...
if have_battery() then
    laptop_widgets = { widget_separator, widget_separator }
    laptop_widgets[3] = batteryarc_widget({
...
local tasklist_buttons = awful.util.table.join(
                     awful.button({ }, 1, function (c)
                                              if c == client.focus then ---@diagnostic disable-line: undefined-global
                                                  c.minimized = true
                                              else
                                                  ...
                                                  client.focus = c ---@diagnostic disable-line: undefined-global
                                                  c:raise()
                                              end
                                          end),
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "j", function () awful.screen.focus(config.screens.left.index) end,
    ...
    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus(config.screens.main.index) end,
              {description = "focus the main screen", group = "screen"}),
    ...
    awful.key({ modkey, "Control" }, "i", function () awful.screen.focus(config.screens.aux.index) end,
              {description = "focus the auxiliary screen", group = "screen"}),
    ...
    awful.key({ modkey,           }, "Tab",
        function ()
            ...
            if client.focus then ---@diagnostic disable-line: undefined-global
                client.focus:raise() ---@diagnostic disable-line: undefined-global
            end
        end,
    ...
    awful.key({ modkey, "Control" }, "r", awesome.restart, ---@diagnostic disable-line: undefined-global
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey, "Shift"   }, "q", awesome.quit, ---@diagnostic disable-line: undefined-global
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "k",      function (c) c:move_to_screen(config.screens.main.index) end,
              {description = "move client to the main screen", group = "client"}),
    ...
    awful.key({ modkey, "Shift"   }, "i",      function (c) c:move_to_screen(config.screens.aux.index) end,
              {description = "move client to the auxiliary screen", group = "client"}),
...
clientkeys = gears.table.join(clientkeys, config.clientkeys)
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Shift" }, "#" .. i + 9,
                  function ()
                      if client.focus then ---@diagnostic disable-line: undefined-global
                          local tag = client.focus.screen.tags[i] ---@diagnostic disable-line: undefined-global
                          if tag then
                              client.focus:move_to_tag(tag) ---@diagnostic disable-line: undefined-global
                          end
                     end
                  end,
        ...
        awful.key({ modkey, "Control", "Shift" }, "#" .. i + 9,
                  function ()
                      if client.focus then ---@diagnostic disable-line: undefined-global
                          local tag = client.focus.screen.tags[i] ---@diagnostic disable-line: undefined-global
                          if tag then
                              client.focus:toggle_tag(tag) ---@diagnostic disable-line: undefined-global
                          end
                      end
                  end,
...
clientbuttons = gears.table.join(
    awful.button({ }, 1, function (c) client.focus = c; c:raise() end), ---@diagnostic disable-line: undefined-global
    awful.button({ modkey }, 1, awful.mouse.client.move),
    awful.button({ modkey }, 3, awful.mouse.client.resize))

root.keys(globalkeys) ---@diagnostic disable-line: undefined-global

root.buttons(gears.table.join( ---@diagnostic disable-line: undefined-global
